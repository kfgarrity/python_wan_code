...
supercell = [1,6,1] #10 septuple layers                                                                                                                                                                                                                
hsurf = ops.generate_supercell(h, supercell, cut=[0,1,0], sparse=False)
...
ds["R"] = [0.5000000000,0.0000000000,  0.5000000000]
ds["$\Gamma$"] = [0.0000000000, 0.0000000000, 0.0000000000]
ds["Z"] = [0.0000000000, 0.0000000000, 0.5000000000]
...
#vals, projs_metal, name_info = ops.band_struct(hsurf,kpts, yrange=[-3, 3], names = names,  fermi=fermi, pdfname="surf_band_struct_noproj.pdf")
...
vals, projs_metal, name_info = ops.band_struct(hsurf,kpts, proj=proj_surf_spin, yrange=[-3, 3], names = names,  fermi=fermi, pdfname="surf_band_struct_projsurf_spin1.pdf")
...
ds2["-X"] = [-0.5000000000, 0.0000000000, 0.0000000000]
ds2["R"] = [0.5000000000,0.0000000000,  0.5000000000]
ds2["-R"] = [-0.5000000000,0.0000000000,  -0.5000000000]
ds2["$\Gamma$"] = [0.0000000000, 0.0000000000, 0.0000000000]
ds2["Z"] = [0.0000000000, 0.0000000000, 0.5000000000]
ds2["-Z"] = [0.0000000000, 0.0000000000, -0.5000000000]
...
vals, projs_metal, name_info = ops.band_struct(hsurf,kpts, proj=proj_surf_spin, yrange=[-2, 1], names = names,  fermi=fermi, pdfname="surf_band_struct_projsurf_X.pdf")
...
vals, projs_metal, name_info = ops.band_struct(hsurf,kpts, proj=proj_surf_spin, yrange=[-2, 1], names = names,  fermi=fermi, pdfname="surf_band_struct_projsurf_Z.pdf")
...
vals, projs_metal, name_info = ops.band_struct(hsurf,kpts, proj=proj_surf_spin, yrange=[-2, 1], names = names,  fermi=fermi, pdfname="surf_band_struct_projsurf_R.pdf")
...
vals, projs_metal, name_info = ops.band_struct(hsurf,kpts, proj=proj_surf_spin, yrange=[-2, 1], names = names,  fermi=fermi, pdfname="surf_band_struct_projsurf_XRZ.pdf")
