...
image, limits, imageproj = ops.unfold_bandstructure(h_small, h_super_r,[2,2,3],kpts, yrange = [-3, 3], names = names, temp=0.02, fermi=fermi, pdfname="unfold_cdw.pdf", num_energies=300, PROJARR=ORBS)
ops.plot_image(image, limits, names=names, pdfname="unfold_cdw_image.pdf")
np.savetxt("unfold_cdw_image.csv", image)
np.savetxt("unfold_cdw_image_proj0.csv", imageproj[:,:,0])
np.savetxt("unfold_cdw_image_proj1.csv", imageproj[:,:,1])
np.savetxt("unfold_cdw_image_proj2.csv", imageproj[:,:,2])
np.savetxt("unfold_cdw_image_proj3.csv", imageproj[:,:,3])

plt.clf()

ops.plot_image(imageproj[:,:,0], limits, names=names, pdfname="unfold_cdw_image_proj0.pdf")
plt.clf()
ops.plot_image(imageproj[:,:,1], limits, names=names, pdfname="unfold_cdw_image_proj1.pdf")
plt.clf()
ops.plot_image(imageproj[:,:,2], limits, names=names, pdfname="unfold_cdw_image_proj2.pdf")
plt.clf()
ops.plot_image(imageproj[:,:,3], limits, names=names, pdfname="unfold_cdw_image_proj3.pdf")
