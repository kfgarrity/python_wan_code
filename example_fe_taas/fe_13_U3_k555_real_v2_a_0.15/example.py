...
orbital_info = [["S", 12, ["p"]], ["Fe", 2, ["d"]], ["Ta", 6, ["d"]]]
...
plt.clf()
vals, projs_fe   , name_info = ops.band_struct(h,kpts, proj=orbs_fe, yrange=[-4, 4], names = names,  fermi=fermi, pdfname="band_struct_fe_"+nstr+".pdf")
plt.clf()
...
np.savetxt("proj_bandstruct_fe_"+nstr+".csv", projs_fe)
...
fnames = ["proj_orbs_ta_dz2_", "proj_orbs_ta_dxz_dyz_", "proj_orbs_ta_dx2y2_", "proj_orbs_ta_dxy_", "proj_orbs_s_pz_", "proj_orbs_s_px_py_","proj_orbs_fe_dz2_", "proj_orbs_fe_dxz_dyz_", "proj_orbs_fe_dx2y2_", "proj_orbs_fe_dxy_"  ]


ORBS = [orbs_ta_dz2, orbs_ta_dxz_dyz, orbs_ta_dx2y2, orbs_ta_dxy, orbs_s_pz, orbs_s_px_py,orbs_fe_dz2, orbs_fe_dxz_dyz, orbs_fe_dx2y2, orbs_fe_dxy]
